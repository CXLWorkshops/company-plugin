...
- **AI-typical phrasing** (applies to every client, on top of their banned words): flag generic AI tells — "unlock the secrets", "unleash the power", "gone are the days", "digital realm", "ever-changing", "game-changer", "in a world", "treasure trove", "furthermore" — and prose so consensus-generic the reader could have prompted it themselves.
